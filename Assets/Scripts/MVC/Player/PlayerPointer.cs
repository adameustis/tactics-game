...
namespace MVC.Player
{
    public class PlayerPointer : MonoBehaviour
    {
        ...
        private void HandleInputCursor(InputAction.CallbackContext context) => SetPointerPosition(Mouse.current.position.ReadValue());
        ...
        private void SubscribeToEvents()
        {
            ...
            Control.Player.Cursor.performed += HandleInputCursor;
        } 

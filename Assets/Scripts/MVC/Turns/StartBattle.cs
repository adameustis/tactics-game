...
namespace MVC.Turns
{
    public class StartBattle : MonoBehaviour
    {
        ...
        #region Events
        [Header("Events")]
        [SerializeField] private UnityEvent<PlayerAndTransformEventData> onStarted;
        ...
        public UnityEvent<PlayerAndTransformEventData> OnStarted { get => onStarted; set => onStarted = value; }
